  ...
  return (
    <div className="footer-section">
      <div className="footer-container">
        <div className="ft-info">
          <div className="ft-info-p1">
            <p className="ft-title">MedicareIQ</p>
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            ...
            <li>
              <a href="tel:0141222">0141222</a>
            </li>
            <li>
              <a href="tel:986733343">986733343</a>
            </li>
            <li>
              <a href="mailto:info@medicareiq.com">info@medicareiq.com</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="ft-copyright">
        <p>©2024 MedicareIQ. All rights reserved.</p>
